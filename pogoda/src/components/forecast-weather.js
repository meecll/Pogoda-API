    ...
    render() {
        const items = this.props.forecast.map((f, i) => {
            ...
            return ( <
                ...
                p className = "forecast-item__temp" > { f.temp } < span className = "forecast-item__degree" > ° < /span> < /
                p > <
                img className = "forecast-item__img"
                src = { image.url }
                alt = { image.alt }
                /> <
        ...
        return ( <
            ...
            <
            h3 className = "forecast__title" > Pogoda godzinowa < /h3> <
